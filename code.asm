section .data
	...
	buffer times 12 db 0 ;buffer to store digits (32 bits + sign + newl> section .text global start global printnum 
...
_start: 
	;note the number to be printed is always stored in eax
	mov eax, 112345 ;number to print
	mov ebx, 112234 ;second number
	add eax, ebx
...
print_num: 
	...
	test eax, eax 
	jnz .extract_digits 
	mov byte [ecx], '0' 	;if zero dec ecx    
        jmp .print
